                    ...
                    <div className="bg-sharpfin-gray text-white p-5 rounded">
                        <form className="grid gap-10 md:p-5 lg:p-10" method="post" netlify-honeypot="bot-field" data-netlify="true" name="contact">
                            ...
                            <div>
                                ...
                                <input id="name" name="name" required className="block text-black p-2 border border-gray-300 pl-4 rounded w-full"></input>
                            </div>
                            <div>
                                <label htmlFor="email" className="">{t.contact.email}*</label>
                                <input id="email" pattern="^\S+@\S+$" name="email" required className="block text-black p-2 border border-gray-300 pl-4 rounded w-full"></input>
                            </div>
                            <div>
                                <label htmlFor="phone" className="">{t.contact.phone}</label>
                                <input id="phone" pattern="[+,-, ,0-9]*" name="phone" className="block text-black p-2 border border-gray-300 pl-4 rounded w-full"></input>
                            </div>
                            <div>
                                <label htmlFor="message" className="">{t.contact.message}*</label>
                                <textarea id="message" name="message" type="texarea" required className="block text-black p-2 border border-gray-300 pl-4 rounded w-full h-full"></textarea>
                            </div>
