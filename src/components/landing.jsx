...
import DudeVideo from '../images/background.mp4'

const Landing = () => {
  return (
    <div>
      <div className="grid gap-10 py-44 mx-5 bg-white" >
        <h1 className="text-3xl sm:text-5xl md:text-6xl tracking-tight font-extrabold text-gray-900 text-center ">
