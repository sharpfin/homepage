    ...
    return (
        <div>
            <div className="grid justify-center  mt-20">
                ...
                <div className="flex flex-nowrap space-x-10 overflow-scroll md:overflow-hidden pl-10">
                    {articles.map(a => (
            ...
            <div className="bg-sharpfin-blue flex flex-col items-center justify-center pb-20 pt-44">
                ...
                <form className="p-5 flex space-y-2 md:space-y-0 md:space-x-2 md:flex-row flex-col w-full justify-center">
