    ...
    return (
        <div className="bg-sharpfin-gray pb-10 grid justify-center">
            ...
            <div className="flex flex-wrap justify-center p-10 gap-10 container">
                ...
                <Link to="/solutions#wealthmanagement" className="bg-white p-5 transform rounded w-96 duration-500 hover:-translate-y-2">
                ...
                <Link to="/solutions#advisory" className="bg-white p-5 transform rounded w-96 duration-500 hover:-translate-y-2">
                ...
                <Link to="/solutions#riskmanagement" className="bg-white p-5 transform rounded w-96 duration-500 hover:-translate-y-2">
                ...
                <Link to="/solutions#wealthadministration" className="bg-white p-5 transform rounded w-96 duration-500 hover:-translate-y-2">
                ...
                <Link to="/solutions#referencedata" className="bg-white p-5 transform rounded w-96 duration-500 hover:-translate-y-2">
