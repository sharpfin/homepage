...
const BlogCard = ({ title, fluid, intro, link }) => {
    return (
        <Link key={title} to={link} className="mt-5 flex-shrink-0 bg-white border shadow-lg rounded-xl max-w-sm transform cursor-pointer duration-500 hover:-translate-y-2" >
